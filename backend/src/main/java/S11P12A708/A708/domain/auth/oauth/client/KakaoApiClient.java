...
import S11P12A708.A708.domain.auth.oauth.request.KakaoTokens;
import S11P12A708.A708.domain.auth.oauth.request.OAuthLoginParams;
import S11P12A708.A708.domain.auth.oauth.response.KakaoInfoResponse;
...
public class KakaoApiClient implements OAuthApiClient {
    ...
    public OAuthInfoResponse requestOauthInfo(String accessToken) {
        ...
        return restTemplate.postForObject(url, request, gKakaoInfoResponse.class);
    }
}